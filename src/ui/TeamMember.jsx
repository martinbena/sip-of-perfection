...
function TeamMember({ fullName, position, phone, email, description, image }) {
  console.log(image);
  return (
    <div className="flex w-2/6 flex-col items-center gap-6 border-b-2 border-b-commontext px-10 pb-4 text-center dtsm:px-4 tablg:px-2 tab:w-5/12 tab:px-0 moblg:w-9/12 mob:w-11/12">
