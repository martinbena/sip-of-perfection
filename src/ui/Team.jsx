...
function Team() {
  return (
    <div className="mx-auto max-w-screen-2xl px-12 tablg:px-4 moblg:px-4">
      <div className="rounded-lg bg-brandtint p-8 mob:px-4 [&>*:nth-child(1)]:mx-auto [&>*:nth-child(1)]:mb-12 [&>*:nth-child(1)]:max-w-max [&>*:nth-child(1)]:border-b-2 [&>*:nth-child(1)]:border-commontext [&>*:nth-child(1)]:pb-2">
