...
function Hero() {
  return (
    <section className="mob:px-5 flex h-screen flex-col items-center justify-center bg-hero-pattern bg-cover bg-center bg-no-repeat px-10 text-center [&>*:nth-child(1)]:mb-6">
      <HeadingPrimary>
